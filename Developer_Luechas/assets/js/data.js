...
const energias = {
  ...
  eolica: {
    ...
    estrellas: 5,
    subtitulo: " Crecimiento anual: +15%",
    descripcion: " la energía eólica aprovecha la fuerza del viento para generar electricidad mediante aerogeneradores. Es una fuente renovable que contribuye a la reducción de emisiones de gases de efecto invernadero.",
    beneficios: [""],
    datos: ["Eficiencia actual: 45-50%"],
    colombia: [ ]
  },
